 ...
 * Chủ đề: Giáo dục công dân, pháp luật, đạo đức, quy tắc ứng xử xã hội
 * Đối tượng: Trẻ em và thanh thiếu niên
 */

export const behaviorQuestions = [
  {
    question: "Khi đi trên đường, em nên làm gì để đảm bảo an toàn?",
    options: [
      "Chạy nhanh qua đường",
      "Nhìn trái, phải rồi mới qua đường",
      "Đi bừa bãi",
      "Chơi điện thoại khi qua đường"
    ],
    correctAnswer: 1,
    explanation: "Phải quan sát kỹ trái phải và tuân thủ tín hiệu giao thông khi qua đường"
  },
  {
 ...
 * @param {Array} usedQuestions - Mảng các index câu hỏi đã sử dụng
 * @returns {Object|null} - Object chứa câu hỏi và index
 */
export const getRandomBehaviorQuestion = (usedQuestions = []) => {
  ...
  const originalIndex = behaviorQuestions.indexOf(question);
